...
"""
    This algorithm searches through a list using the divide and conquer
    methodology, it uses checks wether it is within a certain range rather
    than in individual integer.
"""
...
"""
    this generates random test senarios and tests it against an iterative
    search algorithm which provides a pass senario to compare against, it also
    records all fail states so they can be analysed and find the bugs in the
    algorithm, i have used testing algorithms with most of my programs, to test
    find situations where it fails to complete the task.
"""
def test(passes):
    testcondition=[]
...
def main():
    while 1:
        ...
        try:
            ...
            choice==None
        if choice==1:
            print("Is it in the list: {0}".format(manual_enter()))
        elif choice==2:
            while 1:
                try:
